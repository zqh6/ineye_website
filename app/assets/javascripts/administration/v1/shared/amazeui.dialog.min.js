...
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
    (function (global){
        ...
        dialog.alert = function(options) {
            ...
            var html = [];
            html.push('<div class="am-modal am-modal-alert" tabindex="-blueimp-gallery.min.css">');
        ...
        dialog.confirm = function(options) {
            ...
            var html = [];
            html.push('<div class="am-modal am-modal-confirm" tabindex="-blueimp-gallery.min.css">');
            html.push('<div class="am-modal-dialog">');
            html.push('<div class="am-modal-hd">' + options.title + '</div>');
            html.push('<div class="am-modal-bd">' + options.content + '</div>');
        ...
        dialog.loading = function(options) {
            ...
            var html = [];
            html.push('<div class="am-modal am-modal-loading am-modal-no-btn" tabindex="-blueimp-gallery.min.css" id="my-modal-loading">');
            html.push('<div class="am-modal-dialog">');
            html.push('<div class="am-modal-hd">' + options.title + '</div>');
